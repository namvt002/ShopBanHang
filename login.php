...
<?php
    if(isset($_POST['login'])){
        ...
        $sql = "SELECT * FROM khach_hang WHERE USER_NAME = '$username' AND PASSWORD=MD5('" . $password . "') AND level = '1'";
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" class="user" >
                                        <div class="form-group">
                                            <input type="type" class="form-control form-control-user" name="username" placeholder="Nhập tên tài khoản">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block" name="login" value="Đăng nhập">
                                        <a href="index.php" class="btn btn-primary btn-user btn-block" >Đóng</a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
