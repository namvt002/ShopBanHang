                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">10.000.000 VND</div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">  
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">100.000.000 VND</div>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-center small">
                                ...
                                <span class="mr-2">
                                    <i class="fas fa-circle text-success"></i> Truyền thông
                                </span>
                                <span class="mr-2">
                                    <i class="fas fa-circle text-info"></i> Giới thiệu
                                </span>
                                <span class="mr-2">
                                    <i class="fas fa-circle text-trung"></i> Tiếp thị
                                </span>
                            </div>
                        </div>
                    </div>
